+++
title = "[TCP1PCTF 2023] PDFIFY"
description = "TCP1PCTF was organized by Indonesian and it was opened to anyone. For this challenge specifically, it was really good. I do need to read the source code as well as chaining multiple vulnerabilities such as SQL Injection, SSRF and Insecure Deserialization to get RCE."
date = 2023-10-17T00:14:36+08:00
draft = false
tags = [ "ctf", "deserialization", "web hacking", "SSRF", "SQL Injection" ]
+++
...
{{< figure src="/img/posts/ctf_2023_tcp1pctf_PDFIFY/1.png" caption="Figure 1: Docker ps" width="100%" align="center" >}}
...
{{< figure src="/img/posts/ctf_2023_tcp1pctf_PDFIFY/2.png" caption="Figure 2: SQL injection" width="100%" align="center" >}}

{{< figure src="/img/posts/ctf_2023_tcp1pctf_PDFIFY/3.png" caption="Figure 3: Value was sanitized, paramater was not" width="100%" align="center" >}}

{{< figure src="/img/posts/ctf_2023_tcp1pctf_PDFIFY/4.png" caption="Figure 4: SQL injection sleep" width="100%" align="center" >}}
...
But before that, we need to generate gadget chain to get RCE first. This can be done using existing gadget in [phpggc](https://github.com/ambionics/phpggc). You can generate it directly using phpggc script, or custom. Im using phpggc [gadget(RCE2)](https://github.com/ambionics/phpggc/blob/master/gadgetchains/CodeIgniter4/RCE/2/gadgets.php) as payload and custom script to generate phar file. You also can use other gadget as well, I found out [this(RCE3)](https://github.com/ambionics/phpggc/blob/master/gadgetchains/CodeIgniter4/RCE/3/gadgets.php) gadget much more simpler and the gadget size is much smaller. I also make a blog on how to create your own phar archieve, you can read it [here](/posts/unserialize_without_unserialize/#how-to-use-phar-archive).
...
{{< figure src="/img/posts/ctf_2023_tcp1pctf_PDFIFY/video1.gif" caption="Figure 5: Final exploit" width="100%" align="center" >}}
...
[dockerimage]:/img/posts/ctf_2023_tcp1pctf_PDFIFY/pdfify.zip